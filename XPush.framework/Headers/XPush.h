...
/**
 *	You should call it when application calls [UNUserNotificationCenter center: willPresentNotification:] method.
 */
 ...
 * [AppDelegate application:handleActionWithIdentifier:forRemoteNotification:completionHandler:]
 */
...
+ (void) registerNotificationClickHandler:(MessageClickCallback)callback;

+ (void) registerDeeplinkHandler: (DeeplinkCallback)callback;
